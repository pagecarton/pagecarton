...
class Application_User_NotificationMessage_List extends Application_User_NotificationMessage_Abstract
{
	...
	public function createList()
    {
		...
		$list->listTitle = 'List of Notification Messages on this Application';
		...
		//		'from' => null, 
		//		'to' => null,
				'subject' => '<a title="Edit %FIELD%" rel="changeElementId=' . $this->getObjectName() . '" href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'/tools/classplayer/get/object_name/Application_User_NotificationMessage_Editor/?' . $this->getIdColumn() . '=%KEY%\' );">%FIELD%</a>', 
		//		'body' => null, 
				'mode_name' => null, 
			//	'send' => '<a rel="changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_User_NotificationMessage_Send/?' . $this->getIdColumn() . '=%KEY%">send</a>', 
				'send' => '<a rel="changeElementId=' . $this->getObjectName() . '" href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'/tools/classplayer/get/object_name/Application_User_NotificationMessage_Send/?' . $this->getIdColumn() . '=%KEY%\' );">send</a>', 
		//		'X' => '<a rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_User_NotificationMessage_Delete/?' . $this->getIdColumn() . '=%KEY%">X</a>', 
				'X' => '<a rel="changeElementId=' . $this->getObjectName() . '" href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'/tools/classplayer/get/object_name/Application_User_NotificationMessage_Delete/?' . $this->getIdColumn() . '=%KEY%\' );">X</a>', 
			)
		);
//		var_export( $list );
		return $list;
