...
class Application_User_UserEmail_List extends Application_User_UserEmail_Abstract
{
	...
	//	$this->setIdColumn( 'user_name' );
		...
		$list->createList(  
			array(
				'street_address' => '<a title="Edit address Information" rel="spotlight;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_User_UserEmail_Editor/?' . $this->getIdColumn() . '=%KEY%&">%FIELD%</a>', 
				'city' => null, 
				'province' => null, 
				'country' => null, 
