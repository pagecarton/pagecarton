...
abstract class Application_Domain_Abstract extends Ayoola_Abstract_Table
{
	...
	public static function getSubDomainDirectory( $subDomain = null )
    {
		...
		return APPLICATION_PATH . DS . 'sub_domain' . DS . $subDomain;
	}
 ...
 */			
		...
		//	$option = array_combine( $option, $option );
			$fieldset->addElement( array( 'name' => 'path', 'style' => 'max-width:20%;', 'label' => 'Choose a path to save files for this domain', 'type' => 'Select', 'value' => null ), $option );
			...
			$fieldset->addRequirement( 'directory', array( 'CharacterWhitelist' => array( 'badnews' => 'The allowed characters are lower case alphabets (a-z), numbers (0-9), underscore (_) and hyphen (-).', 'character_list' => '^0-9a-z-_\/', ), 'Uri' => array( 'badnews' => 'You have entered an invalid path', 'required' => false, ), 'WordCount' => array( 5, 50 ) ) );
