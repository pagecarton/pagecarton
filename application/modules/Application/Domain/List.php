...
class Application_Domain_List extends Application_Domain_Abstract
{
	...
	public function createList()
    {
		...
		$list->listTitle = 'Domains on this Application';
		$list->setListOptions( 
								array( 
										...
										'Domain Options' => '<span rel="spotlight;" onClick="ayoola.spotLight.showLinkInIFrame( \'/tools/classplayer/get/object_name/Application_Settings_Editor/settingsname_name/Domains/\' );" title="Domain Availability Tools">Domain Options</span>',
									) 
							);
	...
	//	$this->setIdColumn( 'advert_name' );
		...
		$list->createList(  
			array(
				'domain_name' => '<a title="Click to preview" rel="shadowbox;" href="http://%FIELD%/">%FIELD%</a>',  
				...
				'X' => '<a title="Delete" rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Domain_Delete/?' . $this->getIdColumn() . '=%KEY%">X</a>', 
			)
		);
		//var_export( $list );
		return $list;
