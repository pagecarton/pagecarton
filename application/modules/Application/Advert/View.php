	...
	protected function init()
    {
		try
		{
			...
			//	return $this->setViewContent( '<p class="badnews boxednews">No Adverts to View</p>', true ); 
				...
				{
					return $this->setViewContent( '<a rel="spotlight" href="/tools/classplayer/get/object_name/Application_Advert_List/" class="pc-btn pc-bg-color">Add advertisements here...</a>', true ); 
