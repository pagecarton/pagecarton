...
abstract class Application_ContactUs_Abstract extends Ayoola_Abstract_Table
{
   ...
   //   $form = new Ayoola_Form( array( 'name' => $this->getObjectName(), 'class' => 'smallFormElements' ) );
	...
	//	$fieldset->useDivTagForElement = false;
		...
		//	Contact form
		$fieldset->addElement( array( 'name' => 'contactus_subject', 'label' => 'Subject', 'placeholder' => 'Contact subject...', 'type' => 'InputText', 'value' => @$values['contactus_subject'] ) );
		$fieldset->addElement( array( 'name' => 'contactus_message', 'label' => 'Message', 'placeholder' => 'Please briefly describe the issue you are contacting us about...', 'type' => 'TextArea', 'value' => @$values['contactus_message'] ) );
		$fieldset->addRequirement( 'contactus_message', array( 'WordCount' => array( 100,1000 ) ) );
		...
		$fieldset->placeholderInPlaceOfLabel = true;
		$fieldset->useDivTagForElement = false;
		$fieldset->addElement( array( 'name' => 'contactus_firstname', 'label' => 'Firstname', 'type' => 'InputText', 'value' => @$values['contactus_firstname'] ) );
	...
	//	$fieldset->addRequirement( 'contactus_phone_number', array( 'Digits' => null ) );
		$fieldset->addRequirement( 'contactus_firstname', array( 'WordCount' => array( 6,100 ) ) );
