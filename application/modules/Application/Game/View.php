	...
	protected function init()
    {
		try
		{
			...
			//	return $this->setViewContent( '<p class="badnews boxednews">No Games to View</p>', true ); 
				...
				{
					return $this->setViewContent( '<a rel="spotlight" href="/tools/classplayer/get/object_name/Application_Game_List/" class="pc-btn pc-bg-color">Add Gameisements here...</a>', true ); 
