...
class Application_Subscription_Checkout_CashOnDelivery extends Application_Subscription_Checkout_Abstract
{
	...
	//	$this->setViewContent( '<p>Please ensure p <a target="_blank" href="' . Ayoola_Application::getUrlPrefix() . '/site/contact/">contacting us</a>.</p>' );
		...
		$this->setViewContent( '<h2><a href="' . Ayoola_Application::getUrlPrefix() . '/onlinestore/confirmation/get/api/CashOnDelivery/status/1/"><input name="' . __CLASS__ . '_confirm_order" onClick="ayoola.div.selectElement( this )" class="boxednews goodnews" value="Confirm order" type="button" /></a></h2>' );
	//	$this->setViewContent( '</p>' );
