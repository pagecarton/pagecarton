...
class Application_Subscription_Checkout_DirectDeposit extends Application_Subscription_Checkout_Abstract
{
	...
	//	$this->setViewContent( '<p>' );
		...
		$this->setViewContent( '<p>After payments is made, please ensure you send us the bank payment (or teller) information by <a target="_blank" href="' . Ayoola_Application::getUrlPrefix() . '/site/contact/">contacting us</a>.</p>' );
		...
		$this->setViewContent( '<h2><a href="' . Ayoola_Application::getUrlPrefix() . '/onlinestore/confirmation/get/api/DirectDeposit/status/1/"><input name="' . __CLASS__ . '_confirm_order" onClick="ayoola.div.selectElement( this )" class="boxednews goodnews" value="Confirm order" type="button" /></a></h2>' );
	//	$this->setViewContent( '</p>' );
