...
abstract class Application_Subscription_Checkout_Order_Abstract extends Application_Subscription_Checkout implements Application_Subscription_Checkout_Order_Interface
{
	...
	public function createForm( $submitValue, $legend = null, Array $values = null )
    {
		...
		$fieldset->addElement( array( 'name' => 'order', 'description' => 'Order', 'type' => 'TextArea', 'value' => @$values['order'] ) );
		$fieldset->addElement( array( 'name' => 'order_api', 'description' => 'Payment', 'type' => 'TextArea', 'value' => @$values['order_api'] ) );
