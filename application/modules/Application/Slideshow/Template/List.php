...
class Application_Slideshow_Template_List  extends Application_Slideshow_Template_Abstract
{
    ...
    protected function createList()
    {
		...
		$list->setListOptions( 
								array( 
										'New Slideshow Template' => '<a rel="spotlight;" onClick="ayoola.spotLight.showLinkInIFrame( \'/tools/classplayer/get/object_name/Application_Slideshow_Template_Creator/\' );" title=""> New Slideshow Template </a>',
									) 
							);
