...
*
* @category PageCarton
* @package /ayoola/accounts/notification-message
* @generated Ayoola_Page_Editor_Layout
* @copyright  Copyright (c) PageCarton. (http://www.PageCarton.com)
* @license    http://www.PageCarton.com/license.txt
* @version $Id: notification-message.php	Wednesday 20th of January 2016 11:11:23 AM	 $ 
*/
...
$objay__middlebar0objectEmbed = new Ayoola_Object_Embed( array (
  ...
  'editable' => 'Application_User_NotificationMessage_List',
) );
