...
* @version $Id: terms.php	Wednesday 20th of January 2016 11:06:17 AM	 $ 
*/
...
$objay__middlebar0pageEditText = new Ayoola_Page_Editor_Text( array (
  ...
  'editable' => '<h2>Web Site Terms and Conditions of Use</h2>
...
<ol>
	<li>Permission is granted to temporarily download one copy of the materials (information or software) on our web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
	<ol>
...
<p>We have not reviewed all of the sites linked to our Internet web site and are not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by us of the site. Use of any such linked web site is at the user\'s own risk.</p>
