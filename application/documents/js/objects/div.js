 ...
 */		
		...
		var a = document.getElementsByName( elementObject.name || element.name ); 
	//	alert( a );
 ...
 */	//	editableFormElement.style.minWidth = '90%';
	...
	getParent: function( element, stepsBackward )
	{
		var parentElement = element;
		stepsBackward = stepsBackward || 2;
		stepsBackward++;
		for( var a = 0; a < stepsBackward; a++ )
		{
		//	alert( parentElement );
