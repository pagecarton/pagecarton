...
* @version $Id: pc-tutorials.php	Thursday 18th of July 2019 10:40:32 AM	ayoola@ayoo.la $ 
*/
//	Page Include Content

							if( Ayoola_Loader::loadClass( 'Ayoola_Page_Info' ) )
							{
								
$_ab0cf9e86ffac3a3f42de818ff3b39a9 = new Ayoola_Page_Info( array (
  'widget_options' => 
  array (
    0 => 'parameters',
  ),
  ...
  'use_site_defaults' => '1',
  'widget_name' => 'A r r a y  -  -  A r r a y  -  1',
) );
...
$_ab0cf9e86ffac3a3f42de818ff3b39a9 = null;
...
$_f86d64a69e4acf4dd91ea0e1b6d3452d = new Ayoola_Page_Editor_Text( array (
  'editable' => '<div>
<p>&nbsp;</p>
...
<ul>
	...
	Creating a new email is as easy as just few clicks. Follow the link below to create new emails:<br>
	<br>
	<a class="pc-btn" href="/widgets/Application_User_Email_Creator" target="_blank">Create a new email account&nbsp;@{{{pc_domain}}}</a><br>
	&nbsp;</li>
	<li><strong>Managing Existing Emails</strong><br>
	<br>
	Change passwords, delete emails and manage generally all the email accounts linked to this website using a web interface. Follow the link below to manage email accounts.&nbsp;<br>
	<br>
	<a class="pc-btn" href="/widgets/Application_User_Email_List" target="_blank">Manage existing email accounts</a><br>
	&nbsp;</li>
	<li><strong>Sending &amp; Receiving Emails</strong><br>
	<br>
	You have several options of checking your emails. The easiest to set you is to use our webmail interface to check your email. But you can as well integrate the email account to any digital device like your mobile phones and/or computer.&nbsp;<br>
...
<ol>
	...
	&nbsp;
	<ul>
		<li><a class="pc-btn" href="/widgets/Application_Personalization" target="_blank">Update Branding Content</a><br>
		&nbsp;</li>
	</ul>
	</li>
	<li>Static Content<br>
	...
	&nbsp;
	<ul>
		<li><a class="pc-btn" href="/widgets/Ayoola_Page_Layout_ReplaceText" target="_blank">Update Static Text Content</a>&nbsp;</li>
		<li><a class="pc-btn" href="/widgets/Ayoola_Page_Layout_Images" target="_blank">Update Static Images</a>&nbsp;<br>
		&nbsp;</li>
	</ul>
	</li>
	<li>Dynamic Content<br>
	<br>
	Dynamic site content on PageCarton sites are content that are expected to change frequently. In fact, it allows one to add new dynamic content more frequently so that they could replace the old content on the website. When new dynamic content are added, they don\'t delete the old ones, the old ones may just be taken off the home page but they are also archived and can be accessed by search engines. This is a great way to build up site content to have a lot of information about the organization. Example dynamic contents are blog posts, event &amp; news, testimonials, products &amp; services etc. Dynamic content also have dynamic categories which can be easily updated<br>
	&nbsp;
	<ul>
		<li><a class="pc-btn" href="/widgets/Application_Article_Publisher" target="_blank">Add New Dynamic Content</a>&nbsp;<br>
		<br>
		On the first time a post is being added, one would have to create a profile<br>
		<br>
		Display Name: Your full name<br>
		...
		Other information may be required based on the type of content being added. Most of the fields would be self explanatory.<br>
		<br>
		<a class="pc-btn" href="/widgets/Application_Article_List" target="_blank">Manage All Dynamic Content</a></li>
	</ul>
	</li>
</ol>
...
<ul>
	<li><a class="pc-btn" href="/widgets/Ayoola_Form_List" target="_blank">Custom Forms Data</a></li>
	<li><a class="pc-btn" href="/widgets/Application_ContactUs_List" target="_blank">Contact Us Form Data</a></li>
	<li><a class="pc-btn" href="/widgets/Application_Subscription_Checkout_Order_List" target="_blank">Product &amp; Service Orders</a></li>
</ul>
...
$_f86d64a69e4acf4dd91ea0e1b6d3452d = null;
