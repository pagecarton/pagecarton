...
* @version $Id: l10n.php	Monday 19th of August 2019 07:24:31 PM	ayoola@ayoo.la $ 
*/
...
',
  ...
  'widget_name' => '&nbsp; Localization &nbsp; Localization&nbsp;of PageCarton refers to the&nbsp;adaptation&nbsp;of web content to meet the language cultural and other requirements of a specific target market. PageCarton has been made to support internationalization and so it is ready to be localized into any such language which its users may want. This feature is supported from PageCarton 1.9 and above. &nbsp; Locale Settings You are able to set your preferred localization settings and how you want your site to behave in case where you have a visitor from some particular locale.&nbsp; Default Locale - Sets the default locale which determines&nbsp;date and time formatting&nbsp;decimal separator and system responses. Locale Options - Choose whether to&nbsp; &nbsp; Auto Translate Output Text - Choose whether to translate output text Save new words - choose to save new words which are not currently translated into any local language Auto-Detect Locale - Auto-detect locale through user browser. View or Set Locale Settings &nbsp; Translation &nbsp; You are able to translate your site&nbsp;into any other language of choice. Here are the few steps to achieve this &nbsp; Add new language locale to the Locale List&nbsp;on your site.&nbsp; &nbsp; Locale Name - would be the "English" name of the language to be added. e.g. Russian Native Name - would be the local way of spelling the name of the language e.g. native name of "Russian" is "Русский" and the native name of "Yoruba" is "Yorùbá" Locale Code - The internationalized locale code for the language being added. e.g. Russian is "ru_RU" and Yoruba is "yor" Add new Locale&nbsp;Manage Locale List &nbsp; Put the right Settings up In the PageCarton Locale Settings set Locale Options to "Save new words" and "Auto Translate Output Text".&nbsp; This is to allow PageCarton to pick up words and get them ready to translation into the languages set in the Locale List. We wouldn\'t want to be inputing the words one by one especially for sites loaded with a lot of words already.&nbsp; View or Set Locale Settings Auto populate words&nbsp; Normally all the site pages need to be previewed so that new words may be detected and added to the translation library. But then to simply the process PageCarton now has a widget that call all the pages and widgets automatically in other to invoke the right words into the words translation database. This is now as simple has just clicking a button Populate Words &nbsp; Go to the Locale List to see the list of locale you have added&nbsp;on your site. &nbsp; Now under any of the locale choose the one you wish to translate click on "translations". This will bring up a list of all the populated words.&nbsp;Those would be the words set up for translation. &nbsp; Pick the words one after the other and click on "translate"&nbsp; &nbsp; Enter the translation of the word into the space provided on the screen that opens up &nbsp; Exporting Translation &nbsp;',
  'insert_id' => '1566242671-0-13',
) );
