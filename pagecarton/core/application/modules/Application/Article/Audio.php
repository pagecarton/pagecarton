    ...
    {    
		...
		//		var_export( $postList );
             ...
             //       var_export( $postData['article_url'] );
                    ...
                    {
                        $this->setViewContent( '<p class=""><a class="pc-btn" href="' . $url . '">' . self::__( 'Play All' ) . '<i class="fa fa-play-circle-o" aria-hidden="true"></i></a></p>', true ); 
                    }
        ...
        { 
            ...
            $this->setViewContent( '<p class="badnews">' . self::__( 'Theres an error in the code' ) . '</p>', true ); 
            return false; 
        }
	}
	// END OF CLASS
