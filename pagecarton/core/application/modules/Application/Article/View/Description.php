 ...
 *
 * @category   PageCarton
 * @package    Application_Article_View_Description
 * @copyright  Copyright (c) 2011-2016 PageCarton (http://www.pagecarton.com)
 * @license    GNU General Public License version 2 or later; see LICENSE.txt
 * @version    $Id: Description.php 5.11.2012 12.02am ayoola $
 */
...
class Application_Article_View_Description extends Application_Article_View_Abstract
{
	...
	protected function init()
    {
		...
		//	var_export( Ayoola_Page::getCurrentPageInfo( 'title' ) );
			$this->setViewContent( $data['article_description'], true );
		}
		catch( Exception $e )
		{ 
