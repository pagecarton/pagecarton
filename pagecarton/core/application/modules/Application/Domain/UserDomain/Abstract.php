...
//		$form->oneFieldSetAtATime = true;
   ...
   //   $fieldset->addElement( array( 'name' => 'username', 'type' => 'InputText', 'value' => @$values['username'] ) ); 
		...
		$fieldset->addElement( array( 'name' => 'profile_url', 'label' => 'Linked Profile', 'type' => 'Select', 'value' => @$values['profile_url'] ? : Application_Profile_Abstract::getMyDefaultProfile() ), array( 'Select Profile' ) + $profiles );
