    ...
    {    
		...
		{ 
            ...
            //  Output demo content to screen
             $this->setViewContent( '<h3>How to share ' . Ayoola_Page::getHomePageUrl() . '</h3>' ); 
             $this->setViewContent( '<p>Copy and share content below to any social wall or click the share link below:</p>' );
             ...
             $this->setViewContent( '<textarea style="width:100%;margin: 10px 0; padding: 10px;">' . $text . '</textarea>' );  
             $this->setViewContent( '<a target="_blank" class="pc-btn" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/name/Application_Share/?url=/&title=' . htmlentities( $text ) . '" href="javascript:;"><i  style="margin:5px;" class="fa fa-external-link"></i> Share...</a>' );  
