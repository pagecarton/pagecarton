...
class Application_Status_View extends Application_Status_Abstract
{
    ...
    { 
		try
		{
			...
			{
				$this->setViewContent( '<a class="badnews boxednews" rel="spotlight;" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Status_List/">Edit Statuss</a>' );
			}
			$this->setViewContent( '<a class="goodnews boxednews" rel="spotlight;" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Status_Creator/">Add a testimonial</a>' );
		}
