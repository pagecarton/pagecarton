 ...
 *
 * @advert   Ayoola
 * @package    Application_Database_Account_List
...
class Application_Database_Account_List extends Application_Database_Account_Abstract
{
	...
	public function createList()
    {
		...
		$list->listTitle = 'Database accounts on this Application';
		$list->setData( $this->getDbData() );
		$list->setListOptions( array( 'Creator' => '<a rel="spotlight;height=300px;width=300px;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Database_Account_Creator/" title="Schedule a task with account">+</a> ' ) );
	//	$this->setIdColumn( 'advert_name' );
		...
		$list->createList(  
			array(
				...
				'<a title="Delete" rel="shadowbox;height=300px;width=300px;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_Database_Account_Delete/?' . $this->getIdColumn() . '=%KEY%"><i class="fa fa-trash" aria-hidden="true"></i></a>', 
			)
		);
		//var_export( $list );
		return $list;
