...
class Application_Game_New extends Application_Game_Abstract
{
	...
	//		return false;
		...
		{
			$this->_objectTemplateValues['message'] = 'You have insufficient balance to start a new game. <a href="' . Ayoola_Application::getUrlPrefix() . '/object/name/Application_Wallet_Fund/?amount=70">Add funds</a>';
		}
