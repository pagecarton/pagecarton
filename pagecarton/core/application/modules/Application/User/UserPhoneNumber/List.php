...
class Application_User_UserPhoneNumber_List extends Application_User_UserPhoneNumber_Abstract
{
    ...
    {
		$this->setViewContent( self::__( '<h4>Personal Address Informations. <span class="goodnews"><a title="Add new Address" rel="spotlight;height=300px;width=300px;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_User_UserPhoneNumber_Creator/">+</a></span></h4>' ) );
	...
	//	$this->setIdColumn( 'user_name' );
		...
		$list->createList(  
			array(
				...
				'province' => null, 
				'country' => null,
				'<a title="Delete" rel="spotlight;height=300px;width=300px;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Application_User_UserPhoneNumber_Delete/?' . $this->getIdColumn() . '=%KEY%"><i class="fa fa-trash" aria-hidden="true"></i></a>', 
			)
		);
		//var_export( $list );
		return $list;
