...
class Application_Slideshow_Creator extends Application_Slideshow_Abstract
{
	...
	protected function init()
    {
		...
		{
			case 'post':
				$this->setViewContent( '<a href="' . Ayoola_Application::getUrlPrefix() . '/post/create?article_type=' .  @$values['slideshow_article_type'] . '&category=' .  @$values['category_name'] . '" class="boxednews pc-bg-color">Add new post</a>' ); 
			break;
		//	case 'upload':  
			default:
