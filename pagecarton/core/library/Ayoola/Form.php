...
class Ayoola_Form extends Ayoola_Abstract_Playable
{
    ...
    public function getRequiredFieldset()
    {
		...
		if( $this->submitValue && ! $this->callToAction )
		{
			...
			$element->addElement( array( 'name' => 'pc-submit-button', 'value' => '<span style="margin-right:1em;">' . self::__( $this->submitValue ) . '</span>  <i class="fa fa-chevron-right "></i> ', 'type' => 'SubmitButton', 'onclick' => 'this.form.submit(); this.value=\'Loading...\'; this.disabled=true; return false;', 'style' => 'display:block;margin-top:1.5em;', 'class' => 'pc-btn', 'data-pc-ignore-field' => 'true' ) );    
		}
