...
class Ayoola_Access_AccessInformation_List extends Ayoola_Access_AccessInformation_Abstract
{
	...
	public function createList()
    {
		...
		$list->createList(  
			array(
				'username' => null, 
				'<a title="Delete" rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Ayoola_Access_AccessInformation_Delete/?' . $this->getIdColumn() . '=%KEY%"><i class="fa fa-trash" aria-hidden="true"></i></a>', 
			)
		);
		//var_export( $list );
		return $list;
