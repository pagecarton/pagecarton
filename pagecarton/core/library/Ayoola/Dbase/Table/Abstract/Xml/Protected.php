 ...
 * @package    Ayoola_Dbase_Table_Abstract_Xml_Protected
 * @copyright  Copyright (c) 2011-2016 PageCarton (http://www.pagecarton.com)
 * @license    GNU General Public License version 2 or later; see LICENSE.txt
 * @version    $Id: Protected.php 4.9.12 11.52 ayoola $
 */
...
abstract class Ayoola_Dbase_Table_Abstract_Xml_Protected extends Ayoola_Dbase_Table_Abstract_Xml 
{
