 ...
 *
 * @category   PageCarton
 * @package    Ayoola_Form_Element_Type_Creator
...
class Ayoola_Form_Element_Type_Creator extends Ayoola_Form_Element_Type_Abstract
{
     ...
     * @var string 
     */
	protected static $_objectTitle = 'Add new form element'; 
    ...
    {    
		...
		{ 
			...
			$this->createForm( 'Submit...', 'Add new form element' );
