	...
	class Ayoola_Filter_LayoutIdToPath implements Ayoola_Filter_Interface
	{
		...
		*/
		...
		//		var_export( $checkInt );
			...
			//	var_export( $pagePaths );  
				$PAGE_INCLUDE_FILE = Ayoola_Loader::getFullPath( 'documents/layout/' . $themeName . '/theme/include', array( 'prioritize_my_copy' => true ) )
					?
					:
						Ayoola_Loader::getFullPath( $pagePaths['include'], array( 'prioritize_my_copy' => true ) );
						
				$PAGE_TEMPLATE_FILE = Ayoola_Loader::getFullPath( 'documents/layout/' . $themeName . '/theme/template', array( 'prioritize_my_copy' => true ) )
					?
					:
