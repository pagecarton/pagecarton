 ...
 *
 * @category   PageCarton
 * @package    PageCarton_Locale_Creator
...
class PageCarton_Locale_Creator extends PageCarton_Locale_Abstract
{
    ...
    {    
        ...
        { 
            ...
            $this->setViewContent( self::__( '<p class="badnews">' . $e->getTraceAsString() . '</p>' ) ); 
