...
class PageCarton_NewSiteWizard extends PageCarton_Widget
{
	...
	public function init()
    {
        ...
        //    Application_Personalization::viewInLine();
            $stages = array(
                array( 'key' => 'Basic Meta information', 'title' => 'Set site basic information', 'class' => 'Application_Personalization' ),
                array( 'key' => 'Browse Available Themes', 'title' => 'Choose from hundreds of great themes for your site', 'class' => 'Ayoola_Page_Layout_Repository' ),
                array( 'key' => 'Choose a Theme', 'title' => 'Make a theme the default site theme', 'class' => 'Ayoola_Page_Settings' ),
                array( 'key' => 'Create Creative Content', 'title' => 'Replace dummy text content', 'class' => 'Ayoola_Page_Layout_ReplaceText' ),
                array( 'key' => 'Update Images', 'title' => 'Change some lettering text', 'class' => 'Ayoola_Page_Layout_Images' ),
        ...
        //  $class = $stages[0]['class'];
           ...
           //     $link = ' ';
            ...
            if( Ayoola_Loader::loadClass( $class ) )
            {
               ...
               Step ' . ( $weAreOn ) . ' in ' . count( $stages ) . ' <br><br>
