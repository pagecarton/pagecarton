 ...
 */			if( ! $values = $this->getForm()->getValues() ){ return false; }
		...
		//	if( ! $this->insertDb() ){ return false; }
			...
			{ 
				...
				$this->setViewContent( '<pre class="boxednews normalnews centerednews">' . var_export( $values['encryption_key'], true ) . '</pre><br>' ); 
			//	$this->setViewContent( '<pre class="boxednews normalnews centerednews">' . $values['public_key'] . '</pre><br>' ); 
			}
		}
		catch( Exception $e )
		{ 
