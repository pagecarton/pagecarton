...
class Ayoola_Dbase_Adapter_Xml extends Ayoola_Dbase_Adapter_Abstract
{
     ...
     * @return string
     */
    public function getMySupplementaryDirectory()
    {
		$dir = dirname( $this->getMyFilename() ) . DS . '__' . DS . $this->getTableName();
		return $dir;
	}
     ...
     * @return array
     */
    public function getSupplementaryFilenames()
    {
		try
		{
			//	LOOK FOR SUPPLEMENTARY FILES FOR LARGE RECORDS			
			$files = Ayoola_Doc::getFilesRecursive( $this->getMySupplementaryDirectory(), array( 'key_function' => 'filectime' ) );
		}
		catch( Exception $e )
		{
	...
	//	var_export( $globalFilename );
		if( $paths = Ayoola_Loader::getValidIncludePaths( $globalFilename ) )
		{
