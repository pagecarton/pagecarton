...
{	
	...
	//	var_export( $values );
		...
		if( is_array( Ayoola_Form::getGlobalValue( 'template_options' ) ) && in_array( 'javascript', Ayoola_Form::getGlobalValue( 'template_options' ) ) )
		{
			...
			$fieldset->addElement( array( 'name' => 'javascript_files', 'label' => ' ', 'placeholder' => 'e.g. /path/to/file.js', 'type' => 'MultipleInputText', 'onClick' => 'ayoola.image.formElement = this; ayoola.image.fieldNameValue = \'url\'; ayoola.image.clickBrowseButton( { accept: \'application/x-javascript\' } );', 'value' => @$values['javascript_files'] ), @$values['javascript_files'] );
