...
*/				$dir = Ayoola_Doc::getDocumentsDirectory(); 
			...
			if( ! empty( $_POST['suggested_url'] ) && self::hasPriviledge() )
			{
		...
		//	foreach ($_FILES as $file) 
			do
			{
				...
				if (in_array($fileExtension, $validExtensions)) 
				{
					...
					$maxWith = @intval( $_POST['max_width'] ) ? : 1366;
					$maxHeight = @intval( $_POST['max_height'] ) ? : 768; 
