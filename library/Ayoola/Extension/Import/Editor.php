...
{	
	...
	protected function init()  
    {
		...
		{ 
			...
			$this->setViewContent( '<a href="/object/name/Ayoola_Extension_Import_Download/?extension_name=' . $identifierData['extension_name'] . '" class="boxednews goodnews">Download</a>' );
    } 
	// END OF CLASS
}
