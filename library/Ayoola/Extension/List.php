...
class Ayoola_Extension_List extends Ayoola_Extension_Abstract
{
	...
	public function createList()
    {
		...
		$list->listTitle = 'PageCarton extensions built on this application';
		$list->setData( $this->getDbData() );
		$list->setKey( $this->getIdColumn() );  
		$list->setListOptions( 
								array( 
										'Creator' => '<a rel="spotlight;" onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Ayoola_Extension_Creator/\' );" title="Build a new extension">Build New Extension</a>',
									) 
							);
