...
class Ayoola_Form_Creator extends Ayoola_Form_Abstract
{
    ...
    public function init()
    {
		...
		//	if( ! $this->insertDb() ){ return false; }
			...
			{ 
				$this->setViewContent( '<span class="boxednews normalnews centerednews">Form created successfully. </span>', true ); 
				$this->setViewContent( '<a class="boxednews goodnews centerednews" href="' . $link . '"> Preview it!</a>' ); 
			}
		}
		catch( Exception $e )
		{ 
