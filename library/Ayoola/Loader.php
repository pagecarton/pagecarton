...
class Ayoola_Loader
{
     ...
     */
    public static function getValidIncludePaths( $relativePath )
    {
...
// '/home/ay1000/www/ayoo.la/application/pages/includes/schrobs-page.php' === $file ? var_export( $file ) : null;
			...
			if( is_readable( $file ) ){ $availableFullPaths[$path] = $file; }
       }
/* 			if( $relativePath == 'pages/templates/object.phtml' )
			{
 ...
 */ 		//	var_export( $availableFullPaths );
    ...
    {
		$all = self::getValidIncludePaths( $relativePath );
/* 			if( $relativePath == 'pages/templates/object.phtml' )
			{
                var_export( $all );
            } 
 */	//	'pages/templates/schrob-page.phtml' ==	$relativePath ? var_export( $all ) : null;
    ...
    {
		if( $fullPath = self::getFullPath( $filename ) )
		{
/* 			if( $filename == 'pages/templates/object.phtml' )
			{
                var_export( $fullPath );
                var_export( is_file( $fullPath ) );
            } 
