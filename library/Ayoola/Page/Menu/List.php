...
class Ayoola_Page_Menu_List extends Ayoola_Page_Menu_Abstract
{
	...
	public function createList()
    {
		...
		$list->listTitle = 'List of Menus on this Application';
		...
		//		'menu_name' => null, 
		//		'document_url' => null,
				'+' => '<a title="Add a link option to this menu." rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Ayoola_Page_Menu_Edit_Creator/?' . $this->getIdColumn() . '=%KEY%">+</a>', 
				'-' => '<a title="Edit Menu Information" title="Edit Menu Information" title="Edit Menu Information" rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Ayoola_Page_Menu_Editor/?' . $this->getIdColumn() . '=%KEY%">-</a>', 
